...
pub mod regs {
    ...
    impl defmt::Format for Wupen {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Wupen {{ irqwupen0: {=bool:?}, irqwupen1: {=bool:?}, irqwupen2: {=bool:?}, irqwupen3: {=bool:?}, irqwupen4: {=bool:?}, irqwupen5: {=bool:?}, irqwupen6: {=bool:?}, irqwupen7: {=bool:?}, reserved: {=u8:?}, iwdtwupen: {=bool:?}, keywupen: {=bool:?}, lvd1wupen: {=bool:?}, lvd2wupen: {=bool:?}, reserved_0: {=u8:?}, acmplp0wupen: {=bool:?}, rtcalmwupen: {=bool:?}, rtcprdwupen: {=bool:?}, reserved_1: {=bool:?}, usbfswupen: {=bool:?}, agt1udwupen: {=bool:?}, agt1cawupen: {=bool:?}, agt1cbwupen: {=bool:?}, iic0wupen: {=bool:?} }}" , self . irqwupen0 () , self . irqwupen1 () , self . irqwupen2 () , self . irqwupen3 () , self . irqwupen4 () , self . irqwupen5 () , self . irqwupen6 () , self . irqwupen7 () , self . reserved () , self . iwdtwupen () , self . keywupen () , self . lvd1wupen () , self . lvd2wupen () , self . reserved_0 () , self . acmplp0wupen () , self . rtcalmwupen () , self . rtcprdwupen () , self . reserved_1 () , self . usbfswupen () , self . agt1udwupen () , self . agt1cawupen () , self . agt1cbwupen () , self . iic0wupen ())
        }
    }
}
pub mod vals {
