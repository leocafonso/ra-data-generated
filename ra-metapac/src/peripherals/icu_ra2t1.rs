...
impl Icu {
    ...
    #[doc = "Wakeup Interrupt Enable Register."]
    #[inline(always)]
...
pub mod regs {
    ...
    impl Ielen {
        #[doc = "Parts Asynchronous Interrupts Enable. 0: Disabled. 1: Enabled."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Ielen {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Ielen {{ ielen: {=bool:?} }}", self.ielen())
        }
    }
    #[doc = "ICU Event Link Setting Register %s."]
    #[repr(transparent)]
    ...
    impl Wupen {
        ...
        #[doc = "ACMPHS0 Interrupt Software Standby/Snooze mode Returns Enable. 0: Software Standby/Snooze mode returns by ACMPHS0 interrupt disabled. 1: Software Standby/Snooze mode returns by ACMPHS0 interrupt enabled."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Wupen {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Wupen {{ irqwupen: {:?}, iwdtwupen: {=bool:?}, keywupen: {=bool:?}, lvd1wupen: {=bool:?}, lvd2wupen: {=bool:?}, acmphs0wupen: {=bool:?}, agt1udwupen: {=bool:?}, agt1cawupen: {=bool:?}, agt1cbwupen: {=bool:?}, iic0wupen: {=bool:?} }}" , self . irqwupen () , self . iwdtwupen () , self . keywupen () , self . lvd1wupen () , self . lvd2wupen () , self . acmphs0wupen () , self . agt1udwupen () , self . agt1cawupen () , self . agt1cbwupen () , self . iic0wupen ())
        }
    }
}
pub mod vals {
