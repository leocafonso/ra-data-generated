...
pub mod regs {
    ...
    impl defmt::Format for Nmiclr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmiclr {{ iwdtclr: {=bool:?}, wdtclr: {=bool:?}, lvd1clr: {=bool:?}, lvd2clr: {=bool:?}, ostclr: {=bool:?}, nmiclr: {=bool:?}, rpeclr: {=bool:?}, busmclr: {=bool:?}, tzfclr: {=bool:?}, cpeclr: {=bool:?} }}" , self . iwdtclr () , self . wdtclr () , self . lvd1clr () , self . lvd2clr () , self . ostclr () , self . nmiclr () , self . rpeclr () , self . busmclr () , self . tzfclr () , self . cpeclr ())
        }
    }
    #[doc = "NMI Pin Interrupt Control Register."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Nmier {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmier {{ iwdten: {=bool:?}, wdten: {=bool:?}, lvd1en: {=bool:?}, lvd2en: {=bool:?}, osten: {=bool:?}, nmien: {=bool:?}, rpeen: {=bool:?}, busmen: {=bool:?}, tzfen: {=bool:?}, cpeen: {=bool:?} }}" , self . iwdten () , self . wdten () , self . lvd1en () , self . lvd2en () , self . osten () , self . nmien () , self . rpeen () , self . busmen () , self . tzfen () , self . cpeen ())
        }
    }
    #[doc = "Non-Maskable Interrupt Status Register."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Nmisr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmisr {{ iwdtst: {=bool:?}, wdtst: {=bool:?}, lvd1st: {=bool:?}, lvd2st: {=bool:?}, ostst: {=bool:?}, nmist: {=bool:?}, rpest: {=bool:?}, busmst: {=bool:?}, tzfst: {=bool:?}, cpest: {=bool:?} }}" , self . iwdtst () , self . wdtst () , self . lvd1st () , self . lvd2st () , self . ostst () , self . nmist () , self . rpest () , self . busmst () , self . tzfst () , self . cpest ())
        }
    }
    #[doc = "Wake Up Interrupt Enable Register 0."]
    #[repr(transparent)]
