...
pub mod vals {
    ...
    impl Sels {
        ...
        pub const V_0X000: Self = Self(0x0);
        #[doc = "DTC_COMPLETE."]
        pub const V_0X015: Self = Self(0x15);
        #[doc = "ADC140_WCMPM."]
        pub const V_0X02D: Self = Self(0x2d);
        #[doc = "ADC140_WCMPUM."]
        pub const V_0X02E: Self = Self(0x2e);
        #[doc = "CTSU_CTSUFN."]
        pub const V_0X048: Self = Self(0x48);
        #[doc = "DOC_DOPCI."]
        pub const V_0X04A: Self = Self(0x4a);
        #[doc = "SCI0_AM."]
        pub const V_0X0B0: Self = Self(0xb0);
        #[doc = "SCI0_RXI_OR_ERI."]
        pub const V_0X0B1: Self = Self(0xb1);
    }
    impl Sels {
    ...
    impl core::fmt::Debug for Sels {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            match self.0 {
                0x0 => f.write_str("V_0X000"),
                0x15 => f.write_str("V_0X015"),
                0x2d => f.write_str("V_0X02D"),
                0x2e => f.write_str("V_0X02E"),
                0x48 => f.write_str("V_0X048"),
                0x4a => f.write_str("V_0X04A"),
                0xb0 => f.write_str("V_0X0B0"),
                0xb1 => f.write_str("V_0X0B1"),
                other => core::write!(f, "0x{:02X}", other),
            }
        }
    }
    ...
    impl defmt::Format for Sels {
        fn format(&self, f: defmt::Formatter) {
            match self.0 {
                0x0 => defmt::write!(f, "V_0X000"),
                0x15 => defmt::write!(f, "V_0X015"),
                0x2d => defmt::write!(f, "V_0X02D"),
                0x2e => defmt::write!(f, "V_0X02E"),
                0x48 => defmt::write!(f, "V_0X048"),
                0x4a => defmt::write!(f, "V_0X04A"),
                0xb0 => defmt::write!(f, "V_0X0B0"),
                0xb1 => defmt::write!(f, "V_0X0B1"),
                other => defmt::write!(f, "0x{:02X}", other),
            }
        }
    }
