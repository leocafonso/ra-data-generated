...
pub mod regs {
    ...
    impl Nmiclr {
        ...
        #[doc = "SRAM ECC Error Interrupt Clear. 0: No effect. 1: Clear the NMISR.RECCST flag."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "MPU Bus Slave Error Interrupt Clear. 0: No effect. 1: Clear the NMISR.BUSSST flag."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "MPU Bus Master Error Interrupt Clear. 0: No effect. 1: Clear the NMISR.BUSMST flag."]
        #[must_use]
        #[inline(always)]
    ...
    impl Nmier {
        ...
        #[doc = "Oscillation Stop Detection Interrupt Enable. 0: Main Oscillation stop detection interrupt is disabled. 1: Main Oscillation stop detection interrupt is enabled."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "RAM Parity Error Interrupt Enable. 0: SRAM Parity Error interrupt is disabled. 1: SRAM Parity Error interrupt is enabled."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "SRAM ECC Error Interrupt Enable. 0: SRAM ECC Error interrupt is disabled. 1: SRAM ECC Error interrupt is enabled."]
        #[must_use]
        #[inline(always)]
        ...
        #[doc = "CPU Stack Pointer Monitor Interrupt Enable. 0: CPU Stack Pointer Monitor interrupt is disabled. 1: CPU Stack Pointer Monitor interrupt is enabled."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Nmier {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmier {{ iwdten: {=bool:?}, wdten: {=bool:?}, lvd1en: {=bool:?}, lvd2en: {=bool:?}, reserved: {=u8:?}, osten: {=bool:?}, nmien: {=bool:?}, rpeen: {=bool:?}, reccen: {=bool:?}, bussen: {=bool:?}, busmen: {=bool:?}, speen: {=bool:?}, reserved_0: {=u8:?} }}" , self . iwdten () , self . wdten () , self . lvd1en () , self . lvd2en () , self . reserved () , self . osten () , self . nmien () , self . rpeen () , self . reccen () , self . bussen () , self . busmen () , self . speen () , self . reserved_0 ())
        }
    }
    #[doc = "Non-Maskable Interrupt Status Register."]
    #[repr(transparent)]
    ...
    impl Nmisr {
        ...
        #[doc = "Oscillation Stop Detection Interrupt Status Flag. 0: Main Oscillation stop detection interrupt is not requested. 1: Main Oscillation stop detection interrupt is requested."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Nmisr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmisr {{ iwdtst: {=bool:?}, wdtst: {=bool:?}, lvd1st: {=bool:?}, lvd2st: {=bool:?}, reserved: {=u8:?}, ostst: {=bool:?}, nmist: {=bool:?}, rpest: {=bool:?}, reccst: {=bool:?}, bussst: {=bool:?}, busmst: {=bool:?}, spest: {=bool:?}, reserved_0: {=u8:?} }}" , self . iwdtst () , self . wdtst () , self . lvd1st () , self . lvd2st () , self . reserved () , self . ostst () , self . nmist () , self . rpest () , self . reccst () , self . bussst () , self . busmst () , self . spest () , self . reserved_0 ())
        }
    }
    #[doc = "SYS Event Link Setting Register."]
    #[repr(transparent)]
    ...
    impl Wupen {
        ...
        #[doc = "ACMPLP0 interrupt S/W standby returns enable bit. 0: S/W standby returns by ACMPLP0 interrupt is disabled. 1: S/W standby returns by ACMPLP0 interrupt is enabled."]
        #[must_use]
        #[inline(always)]
