...
pub mod regs {
    ...
    impl defmt::Format for Wupen0 {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Wupen0 {{ irqwupen: {:?}, iwdtwupen: {=bool:?}, lvd1wupen: {=bool:?}, lvd2wupen: {=bool:?}, agt1udwupen: {=bool:?}, agt1cawupen: {=bool:?}, agt1cbwupen: {=bool:?} }}" , self . irqwupen () , self . iwdtwupen () , self . lvd1wupen () , self . lvd2wupen () , self . agt1udwupen () , self . agt1cawupen () , self . agt1cbwupen ())
        }
    }
    #[doc = "Wake Up Interrupt Enable Register 1."]
    #[repr(transparent)]
