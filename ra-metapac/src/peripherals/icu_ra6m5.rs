...
pub mod regs {
    ...
    impl Nmiclr {
        ...
        #[doc = "0: No effect. 1: Clear the NMISR.CPECLR flag."]
        #[must_use]
        #[inline(always)]
    ...
    impl Wupen0 {
        ...
        #[doc = "USBHS Interrupt Software Standby/Snooze Mode Returns Enable bit. 0: Software Standby/Snooze Mode returns by USBHS interrupt is disabled. 1: Software Standby/Snooze Mode returns by USBHS interrupt is enabled."]
        #[must_use]
        #[inline(always)]
