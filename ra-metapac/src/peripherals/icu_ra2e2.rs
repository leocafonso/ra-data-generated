...
pub mod regs {
    ...
    impl Ielen {
        #[doc = "Parts Asynchronous Interrupts Enable (when LPOPTEN bit = 1). 0: Disabled. 1: Enabled."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Nmiclr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmiclr {{ iwdtclr: {=bool:?}, wdtclr: {=bool:?}, lvd1clr: {=bool:?}, lvd2clr: {=bool:?}, nmiclr: {=bool:?}, rpeclr: {=bool:?}, bussclr: {=bool:?}, busmclr: {=bool:?}, speclr: {=bool:?} }}" , self . iwdtclr () , self . wdtclr () , self . lvd1clr () , self . lvd2clr () , self . nmiclr () , self . rpeclr () , self . bussclr () , self . busmclr () , self . speclr ())
        }
    }
    #[doc = "NMI Pin Interrupt Control Register."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Nmier {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmier {{ iwdten: {=bool:?}, wdten: {=bool:?}, lvd1en: {=bool:?}, lvd2en: {=bool:?}, nmien: {=bool:?}, rpeen: {=bool:?}, bussen: {=bool:?}, busmen: {=bool:?}, speen: {=bool:?} }}" , self . iwdten () , self . wdten () , self . lvd1en () , self . lvd2en () , self . nmien () , self . rpeen () , self . bussen () , self . busmen () , self . speen ())
        }
    }
    #[doc = "Non-Maskable Interrupt Status Register."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Nmisr {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Nmisr {{ iwdtst: {=bool:?}, wdtst: {=bool:?}, lvd1st: {=bool:?}, lvd2st: {=bool:?}, nmist: {=bool:?}, rpest: {=bool:?}, bussst: {=bool:?}, busmst: {=bool:?}, spest: {=bool:?} }}" , self . iwdtst () , self . wdtst () , self . lvd1st () , self . lvd2st () , self . nmist () , self . rpest () , self . bussst () , self . busmst () , self . spest ())
        }
    }
    #[doc = "Wake Up Interrupt Enable Register."]
    #[repr(transparent)]
    ...
    impl defmt::Format for Wupen {
        fn format(&self, f: defmt::Formatter) {
            defmt :: write ! (f , "Wupen {{ irqwupen: {:?}, iwdtwupen: {=bool:?}, keywupen: {=bool:?}, lvd1wupen: {=bool:?}, lvd2wupen: {=bool:?}, agt1udwupen: {=bool:?}, agt1cawupen: {=bool:?}, agt1cbwupen: {=bool:?} }}" , self . irqwupen () , self . iwdtwupen () , self . keywupen () , self . lvd1wupen () , self . lvd2wupen () , self . agt1udwupen () , self . agt1cawupen () , self . agt1cbwupen ())
        }
    }
}
pub mod vals {
