...
pub mod regs {
    ...
    impl Wupen1 {
        #[doc = "I3C Address Match Interrupt Software Standby/Snooze Mode Returns Enable bit. 0: Software Standby/Snooze Mode returns by I3C address match interrupt is disabled. 1: Software Standby/Snooze Mode returns by I3C address match interrupt is enabled."]
        #[must_use]
        #[inline(always)]
    ...
    impl defmt::Format for Wupen1 {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(f, "Wupen1 {{ i3cwupen: {=bool:?} }}", self.i3cwupen())
        }
    }
}
pub mod vals {
